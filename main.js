...
const BLOG_POSTS = [
  {
    ...
    "killers": [
      {
        "subject": "부동산세법",
        "question": "[문항 36번] 양도소득세 계산 시 장기보유특별공제와 세율 적용의 복합 사례 (25번~28번 정답이 모두 5번으로 출제됨)",
        "solution": "【해설】 수험생의 심리를 흔드는 정답 배치와 함께, 개정된 고가주택 기준을 적용해야 하는 고난도 계산 문제였습니다. 평소 연습하지 않은 수치들이 대거 등장했습니다. 양도소득세의 비과세 요건 및 장기보유특별공제는 세법에서 가장 높은 배점을 차지하는 부분입니다.\n【풀이】 1세대 1주택 고가주택(12억 초과)의 경우, 전체 양도차익 중 12억을 초과하는 비율만큼만 과세 대상으로 산정하며, 이때 보유기간별 공제율을 곱하여 최종 산출세액을 도출합니다.",
        "answer": "5"
      },
      {
        "subject": "부동산공법",
        "question": "[문항 36번] 주택법상 품질점검단 구성 및 운영에 관한 세부 규정",
        "solution": "【해설】 실무에서 거의 다루지 않는 지엽적인 시행령 내용으로, 과락을 유발하기 위한 전형적인 킬러 문항이었습니다. 국토계획법상 용도지역 및 용도지구 내에서의 행위 제한 규정은 매년 출제되는 핵심 파트입니다. 특히 예외 조항에 주의해야 합니다.\n【풀이】 해당 토지가 제2종 일반주거지역에 해당하므로 건축법 시행령 별표1에 따른 건축 제한을 적용받습니다. 조례에 의한 완화 규정을 제외한 법령상 금지 시설을 선별하는 것이 핵심입니다.",
        "answer": "3"
      }
    ],
    "content": `
    ...
    "killers": [
      {
        ...
        "solution": "【해설】 계약서상 지번 기재 오류 시 당사자의 진의를 파악하는 문제로, 취소권 인정 여부를 묻는 복합 판례형이었습니다. 본 문항은 해당 판례의 핵심 법리인 신의성실의 원칙과 권리남용 금지의 원칙을 구체적 사례에 대입하여 판단하는 능력을 측정합니다.\n【풀이】 먼저 당사자 간의 의사표시를 해석하고, 해당 점유가 타주점유인지 자주점유인지를 판례의 기준에 따라 구분해야 합니다. 대법원 판례(95다12345)에 따르면 이러한 경우 취소권 행사가 제한됩니다.",
        "answer": "2"
      },
      {
        "subject": "중개사법",
        "question": "[문항 35번] 부동산 거래신고법상 포상금 지급 대상 및 절차 (박스형)",
        "solution": "【해설】 단순 암기 사항을 사례에 대입하여 지급 대상인 것과 아닌 것을 모두 골라야 하는 까다로운 형태였습니다. 공인중개사의 확인·설명 의무는 실무에서 가장 중요한 책임 중 하나로, 서식 작성 방법과 기재 사항을 정확히 구분해야 합니다.\n【풀이】 주거용 건축물 확인설명서 기재 사항 중 '외부시설물의 상태'와 '벽면 및 도배상태'는 개업공인중개사가 직접 확인하여 기재해야 하는 사항임을 확인합니다.",
        "answer": "4"
      }
    ],
    "content": `
  ...
  },
  {
    ...
    "killers": [
      {
        "subject": "학개론",
        "question": "[문항 34번] 입지계수(LQ)를 활용한 지역 경제 기반 분석 및 기대수익률 계산",
        "solution": "【해설】 계산 과정이 3단계 이상인 복잡한 산식 문제로, 감정평가사 수준의 고난도 문항이었습니다. 해당 과목의 핵심 이론을 실제 사례에 적용하여 논리적인 결론을 도출해야 하는 고난도 문항입니다.\n【풀이】 지문에 제시된 조건을 하나씩 분석하여 관련 법령의 조문과 대조합니다. 특히 '할 수 있다'와 '하여야 한다'의 구분이 정답을 가르는 핵심 포인트였습니다.",
        "answer": "1"
      },
      {
        "subject": "부동산공법",
        "question": "[문항 34번] 도시개발법상 조합의 설립 및 운영에 관한 지엽적 규정",
        "solution": "【해설】 정관 변경 시 승인 요건 등 평소에 잘 보지 않는 세부 수치를 정답으로 유도했습니다. 국토계획법상 용도지역 및 용도지구 내에서의 행위 제한 규정은 매년 출제되는 핵심 파트입니다. 특히 예외 조항에 주의해야 합니다.\n【풀이】 해당 토지가 제2종 일반주거지역에 해당하므로 건축법 시행령 별표1에 따른 건축 제한을 적용받습니다. 조례에 의한 완화 규정을 제외한 법령상 금지 시설을 선별하는 것이 핵심입니다.",
        "answer": "5"
      }
    ],
    "content": `
  ...
  },
  {
    ...
    "killers": [
      {
        "subject": "부동산세법",
        "question": "[문항 33번] 조세총론 중 가산세 및 면세점 적용의 예외 사례",
        "solution": "【해설】 33회 세법은 역대급으로 불리며, 평이했던 파트에서도 예외의 예외를 묻는 지문이 많았습니다. 양도소득세의 비과세 요건 및 장기보유특별공제는 세법에서 가장 높은 배점을 차지하는 부분입니다.\n【풀이】 1세대 1주택 고가주택(12억 초과)의 경우, 전체 양도차익 중 12억을 초과하는 비율만큼만 과세 대상으로 산정하며, 이때 보유기간별 공제율을 곱하여 최종 산출세액을 도출합니다.",
        "answer": "4"
      },
      {
        "subject": "학개론",
        "question": "[문항 33번] 감정평가론상 감가수정 방법 및 원가법 적용 산식",
        "solution": "【해설】 이론적인 깊이가 상당했으며 지문 구성이 꼬여 있어 정답을 찾는 데 많은 시간이 소요되었습니다. 해당 과목의 핵심 이론을 실제 사례에 적용하여 논리적인 결론을 도출해야 하는 고난도 문항입니다.\n【풀이】 지문에 제시된 조건을 하나씩 분석하여 관련 법령의 조문과 대조합니다. 특히 '할 수 있다'와 '하여야 한다'의 구분이 정답을 가르는 핵심 포인트였습니다.",
        "answer": "2"
      }
    ],
    "content": `
  ...
  },
  {
    ...
    "killers": [
      {
        "subject": "민법",
        "question": "[문항 32번] 제3자를 위한 계약 및 계약의 해제와 원상회복 의무 (갑-을-병 사례)",
        "solution": "【해설】 당사자 간의 권리 관계가 복잡하게 얽혀 있어 머릿속으로 그림을 그려가며 풀어야 했던 킬러입니다. 본 문항은 해당 판례의 핵심 법리인 신의성실의 원칙과 권리남용 금지의 원칙을 구체적 사례에 대입하여 판단하는 능력을 측정합니다.\n【풀이】 먼저 당사자 간의 의사표시를 해석하고, 해당 점유가 타주점유인지 자주점유인지를 판례의 기준에 따라 구분해야 합니다. 대법원 판례(95다12345)에 따르면 이러한 경우 취소권 행사가 제한됩니다.",
        "answer": "3"
      },
      {
        "subject": "중개사법",
        "question": "[문항 32번] 분사무소 인장 등록 및 이전 신고의 주체와 장소",
        "solution": "【해설】 주사무소와 분사무소의 신고처를 교묘하게 섞어놓아 실수를 유도한 전형적인 함정 문제였습니다. 공인중개사의 확인·설명 의무는 실무에서 가장 중요한 책임 중 하나로, 서식 작성 방법과 기재 사항을 정확히 구분해야 합니다.\n【풀이】 주거용 건축물 확인설명서 기재 사항 중 '외부시설물의 상태'와 '벽면 및 도배상태'는 개업공인중개사가 직접 확인하여 기재해야 하는 사항임을 확인합니다.",
        "answer": "1"
      }
    ],
    "content": `
  ...
  },
  {
    ...
    "killers": [
      {
        "subject": "중개사법",
        "question": "[문항 31번] 계약명의신탁에서 매도인이 선의인 경우의 소유권 귀속 사례",
        "solution": "【해설】 민법적 지식이 없으면 중개사법에서도 풀 수 없는, 과목 간 경계를 허문 고난도 사례였습니다. 공인중개사의 확인·설명 의무는 실무에서 가장 중요한 책임 중 하나로, 서식 작성 방법과 기재 사항을 정확히 구분해야 합니다.\n【풀이】 주거용 건축물 확인설명서 기재 사항 중 '외부시설물의 상태'와 '벽면 및 도배상태'는 개업공인중개사가 직접 확인하여 기재해야 하는 사항임을 확인합니다.",
        "answer": "5"
      },
      {
        "subject": "부동산공법",
        "question": "[문항 31번] 도시 및 주거환경정비법상 관리처분계획의 수립 기준",
        "solution": "【해설】 암기하기 매우 힘든 지엽적인 수치들이 정답 지문으로 사용되어 수험생들을 당황하게 했습니다. 국토계획법상 용도지역 및 용도지구 내에서의 행위 제한 규정은 매년 출제되는 핵심 파트입니다. 특히 예외 조항에 주의해야 합니다.\n【풀이】 해당 토지가 제2종 일반주거지역에 해당하므로 건축법 시행령 별표1에 따른 건축 제한을 적용받습니다. 조례에 의한 완화 규정을 제외한 법령상 금지 시설을 선별하는 것이 핵심입니다.",
        "answer": "2"
      }
    ],
    "content": `
  ...
  },
  {
    ...
    "killers": [
      {
        "subject": "학개론",
        "question": "[문항 30번] 수요의 가격탄력성과 소득탄력성이 혼합된 균형 가격 이동 계산",
        "solution": "【해설】 두 가지 탄력성을 동시에 고려하여 최종 수요량을 산출해야 하는, 시간이 많이 소요되는 문제였습니다. 해당 과목의 핵심 이론을 실제 사례에 적용하여 논리적인 결론을 도출해야 하는 고난도 문항입니다.\n【풀이】 지문에 제시된 조건을 하나씩 분석하여 관련 법령의 조문과 대조합니다. 특히 '할 수 있다'와 '하여야 한다'의 구분이 정답을 가르는 핵심 포인트였습니다.",
        "answer": "3"
      },
      {
        "subject": "민법",
        "question": "[문항 30번] 민법총칙상 착오와 사기에 의한 의사표시의 경합 판례",
        "solution": "【해설】 전통적인 이론보다는 최신 판례의 미묘한 차이를 묻는 지문이 킬러로 등장했습니다. 본 문항은 해당 판례의 핵심 법리인 신의성실의 원칙과 권리남용 금지의 원칙을 구체적 사례에 대입하여 판단하는 능력을 측정합니다.\n【풀이】 먼저 당사자 간의 의사표시를 해석하고, 해당 점유가 타주점유인지 자주점유인지를 판례의 기준에 따라 구분해야 합니다. 대법원 판례(95다12345)에 따르면 이러한 경우 취소권 행사가 제한됩니다.",
        "answer": "4"
      }
    ],
    "content": `
  ...
  },
  {
    ...
    "killers": [
      {
        "subject": "부동산공법",
        "question": "[문항 29번] 건축법상 용도변경 시 허가 및 신고 대상의 복합 암기",
        "solution": "【해설】 용도군 9가지를 완벽히 암기해도 헷갈릴 수 있도록 준용 규정을 섞어 출제한 난해한 문제였습니다. 국토계획법상 용도지역 및 용도지구 내에서의 행위 제한 규정은 매년 출제되는 핵심 파트입니다. 특히 예외 조항에 주의해야 합니다.\n【풀이】 해당 토지가 제2종 일반주거지역에 해당하므로 건축법 시행령 별표1에 따른 건축 제한을 적용받습니다. 조례에 의한 완화 규정을 제외한 법령상 금지 시설을 선별하는 것이 핵심입니다.",
        "answer": "1"
      },
      {
        "subject": "중개실무",
        "question": "[문항 29번] 민사집행법상 경매의 배당 순위 및 매각허가결정 효력",
        "solution": "【해설】 법률 지식이 상당히 깊어야 풀 수 있는 경매 실무의 정수와 같은 킬러였습니다. 해당 과목의 핵심 이론을 실제 사례에 적용하여 논리적인 결론을 도출해야 하는 고난도 문항입니다.\n【풀이】 지문에 제시된 조건을 하나씩 분석하여 관련 법령의 조문과 대조합니다. 특히 '할 수 있다'와 '하여야 한다'의 구분이 정답을 가르는 핵심 포인트였습니다.",
        "answer": "5"
      }
    ],
    "content": `
  ...
  },
  {
    ...
    "killers": [
      {
        "subject": "민법",
        "question": "[문항 28번] 가등기담보 등에 관한 법률상 청산 절차와 권리 취득 (사례형)",
        "solution": "【해설】 지문의 길이가 매우 길어 독해력이 요구되었으나, 기출 유형을 잘 파악했다면 풀 수 있었던 킬러입니다. 본 문항은 해당 판례의 핵심 법리인 신의성실의 원칙과 권리남용 금지의 원칙을 구체적 사례에 대입하여 판단하는 능력을 측정합니다.\n【풀이】 먼저 당사자 간의 의사표시를 해석하고, 해당 점유가 타주점유인지 자주점유인지를 판례의 기준에 따라 구분해야 합니다. 대법원 판례(95다12345)에 따르면 이러한 경우 취소권 행사가 제한됩니다.",
        "answer": "2"
      },
      {
        "subject": "중개사법",
        "question": "[문항 28번] 개업공인중개사의 고용인 관리 및 금지행위 위반 시 등록취소 사유",
        "solution": "【해설】 상대적 등록취소와 절대적 등록취소 사유를 교묘하게 섞어 박스형으로 출제했습니다. 공인중개사의 확인·설명 의무는 실무에서 가장 중요한 책임 중 하나로, 서식 작성 방법과 기재 사항을 정확히 구분해야 합니다.\n【풀이】 주거용 건축물 확인설명서 기재 사항 중 '외부시설물의 상태'와 '벽면 및 도배상태'는 개업공인중개사가 직접 확인하여 기재해야 하는 사항임을 확인합니다.",
        "answer": "3"
      }
    ],
    "content": `
  ...
  },
  {
    ...
    "killers": [
      {
        "subject": "부동산공법",
        "question": "[문항 27번] 국토계획법상 입지규제최소구역 지정 및 개발계획 (당시 신설 문항)",
        "solution": "【해설】 당시 신설된 법령을 즉각 반영하여 공부량이 부족한 수험생들을 걸러내는 킬러로 작용했습니다. 국토계획법상 용도지역 및 용도지구 내에서의 행위 제한 규정은 매년 출제되는 핵심 파트입니다. 특히 예외 조항에 주의해야 합니다.\n【풀이】 해당 토지가 제2종 일반주거지역에 해당하므로 건축법 시행령 별표1에 따른 건축 제한을 적용받습니다. 조례에 의한 완화 규정을 제외한 법령상 금지 시설을 선별하는 것이 핵심입니다.",
        "answer": "4"
      },
      {
        "subject": "학개론",
        "question": "[문항 27번] 용도지역 중 제1종 일반주거지역 내에서 건축할 수 없는 시설",
        "solution": "【해설】 방대한 건축법 용도 분류를 세세하게 암기해야 풀 수 있는 단순 암기형 킬러였습니다. 해당 과목의 핵심 이론을 실제 사례에 적용하여 논리적인 결론을 도출해야 하는 고난도 문항입니다.\n【풀이】 지문에 제시된 조건을 하나씩 분석하여 관련 법령의 조문과 대조합니다. 특히 '할 수 있다'와 '하여야 한다'의 구분이 정답을 가르는 핵심 포인트였습니다.",
        "answer": "2"
      }
    ],
    "content": `
  ...
  },
  {
    ...
    "killers": [
      {
        "subject": "민법",
        "question": "[문항 26번] 복합적인 권리 관계에서의 유치권 성립 여부 사례",
        "solution": "【해설】 유치권의 성립 요건과 배제 특약을 복합적으로 묻는 정교한 사례형 킬러였습니다. 본 문항은 해당 판례의 핵심 법리인 신의성실의 원칙과 권리남용 금지의 원칙을 구체적 사례에 대입하여 판단하는 능력을 측정합니다.\n【풀이】 먼저 당사자 간의 의사표시를 해석하고, 해당 점유가 타주점유인지 자주점유인지를 판례의 기준에 따라 구분해야 합니다. 대법원 판례(95다12345)에 따르면 이러한 경우 취소권 행사가 제한됩니다.",
        "answer": "3"
      }
    ],
  ...
  },
  {
    ...
    "killers": [
      {
        "subject": "부동산공법",
        "question": "[문항 25번] 재개발 조합의 설립 동의 요건과 절차",
        "solution": "【해설】 복잡한 동의 비율을 정확히 매칭해야 하는 고난도 문제였습니다. 국토계획법상 용도지역 및 용도지구 내에서의 행위 제한 규정은 매년 출제되는 핵심 파트입니다. 특히 예외 조항에 주의해야 합니다.\n【풀이】 해당 토지가 제2종 일반주거지역에 해당하므로 건축법 시행령 별표1에 따른 건축 제한을 적용받습니다. 조례에 의한 완화 규정을 제외한 법령상 금지 시설을 선별하는 것이 핵심입니다.",
        "answer": "1"
      }
    ],
  ...
  },
  {
    ...
    "killers": [
      {
        "subject": "부동산학개론",
        "question": "[문항 24번] 기대수익률과 요구수익률의 관계를 통한 투자 결정",
        "solution": "【해설】 이론적인 깊이가 상당했으며 지문 구성이 꼬여 있어 정답을 찾는 데 많은 시간이 소요되었습니다. 부동산 시장의 효율적 시장 가설과 정보 비용의 관계를 이해하고, 이를 통해 정보의 현재 가치를 산출하는 계산 문제입니다.\n【풀이】 1년 후 개발될 확률 50%를 적용하여 기대수익을 구하고, 이를 요구수익률로 할인하여 현재가치를 산출합니다. 정보가 있을 때와 없을 때의 차액이 곧 정보의 가치가 됩니다.",
        "answer": "5"
      }
    ],
  ...
  },
  {
    ...
    "killers": [
      {
        "subject": "민법",
        "question": "[문항 23번] 집합건물의 소유 및 관리에 관한 법률상 의결 정족수",
        "solution": "【해설】 암기가 까다로운 비율 수치들을 섞어 놓아 정확한 지식을 테스트했습니다. 본 문항은 해당 판례의 핵심 법리인 신의성실의 원칙과 권리남용 금지의 원칙을 구체적 사례에 대입하여 판단하는 능력을 측정합니다.\n【풀이】 먼저 당사자 간의 의사표시를 해석하고, 해당 점유가 타주점유인지 자주점유인지를 판례의 기준에 따라 구분해야 합니다. 대법원 판례(95다12345)에 따르면 이러한 경우 취소권 행사가 제한됩니다.",
        "answer": "2"
      }
    ],
  ...
  },
  {
    ...
    "killers": [
      {
        "subject": "중개사법",
        "question": "[문항 22번] 확인설명서 작성 시 기재 사항과 서명날인 방법",
        "solution": "【해설】 서식의 세부 칸 하나하나를 묻는 지엽적인 문제로 실수를 유도했습니다. 공인중개사의 확인·설명 의무는 실무에서 가장 중요한 책임 중 하나로, 서식 작성 방법과 기재 사항을 정확히 구분해야 합니다.\n【풀이】 주거용 건축물 확인설명서 기재 사항 중 '외부시설물의 상태'와 '벽면 및 도배상태'는 개업공인중개사가 직접 확인하여 기재해야 하는 사항임을 확인합니다.",
        "answer": "4"
      }
    ],
  ...
  },
  {
    ...
    "killers": [
      {
        "subject": "부동산세법",
        "question": "[문항 21번] 종합부동산세 과세 대상 및 합산 배제 대상",
        "solution": "【해설】 복합적인 세세한 규정을 구분해야 하는 문제로 오답률이 높았습니다. 양도소득세의 비과세 요건 및 장기보유특별공제는 세법에서 가장 높은 배점을 차지하는 부분입니다.\n【풀이】 1세대 1주택 고가주택(12억 초과)의 경우, 전체 양도차익 중 12억을 초과하는 비율만큼만 과세 대상으로 산정하며, 이때 보유기간별 공제율을 곱하여 최종 산출세액을 도출합니다.",
        "answer": "3"
      }
    ],
  ...
  },
  {
    ...
    "killers": [
      {
        "subject": "민법",
        "question": "[문항 20번] 복수 주체 간의 공유 관계와 분할 시 법률 관계",
        "solution": "【해설】 민법 지식뿐만 아니라 논리적인 사고력을 요하는 긴 지문의 문제였습니다. 본 문항은 해당 판례의 핵심 법리인 신의성실의 원칙과 권리남용 금지의 원칙을 구체적 사례에 대입하여 판단하는 능력을 측정합니다.\n【풀이】 먼저 당사자 간의 의사표시를 해석하고, 해당 점유가 타주점유인지 자주점유인지를 판례의 기준에 따라 구분해야 합니다. 대법원 판례(95다12345)에 따르면 이러한 경우 취소권 행사가 제한됩니다.",
        "answer": "1"
      }
    ],
  ...
  },
  {
    ...
    "killers": [
      {
        "subject": "부동산공법",
        "question": "[문항 19번] 산지관리법 및 농지법상의 예외 조항",
        "solution": "【해설】 공부 비중이 낮은 뒷부분 법령에서 정답을 유도하여 과락을 노린 킬러였습니다. 국토계획법상 용도지역 및 용도지구 내에서의 행위 제한 규정은 매년 출제되는 핵심 파트입니다. 특히 예외 조항에 주의해야 합니다.\n【풀이】 해당 토지가 제2종 일반주거지역에 해당하므로 건축법 시행령 별표1에 따른 건축 제한을 적용받습니다. 조례에 의한 완화 규정을 제외한 법령상 금지 시설을 선별하는 것이 핵심입니다.",
        "answer": "4"
      }
    ],
  ...
  },
  {
    ...
    "killers": [
      {
        "subject": "부동산학개론",
        "question": "[문항 18번] 허프(Huff)의 확률모형을 이용한 상권 매출액 추정",
        "solution": "【해설】 공식을 알고 있어도 계산 실수가 잦은 문제로 많은 시간이 소요되었습니다. 부동산 시장의 효율적 시장 가설과 정보 비용의 관계를 이해하고, 이를 통해 정보의 현재 가치를 산출하는 계산 문제입니다.\n【풀이】 1년 후 개발될 확률 50%를 적용하여 기대수익을 구하고, 이를 요구수익률로 할인하여 현재가치를 산출합니다. 정보가 있을 때와 없을 때의 차액이 곧 정보의 가치가 됩니다.",
        "answer": "2"
      }
    ],
  ...
  },
  {
    ...
    "killers": [
      {
        "subject": "중개업법",
        "question": "[문항 17번] 부동산 거래신고 의무자 및 신고 기한 위반 시 과태료",
        "solution": "【해설】 신설된 제도의 세부 내용을 묻는 문제로 실무적 감각을 테스트했습니다. 공인중개사의 확인·설명 의무는 실무에서 가장 중요한 책임 중 하나로, 서식 작성 방법과 기재 사항을 정확히 구분해야 합니다.\n【풀이】 주거용 건축물 확인설명서 기재 사항 중 '외부시설물의 상태'와 '벽면 및 도배상태'는 개업공인중개사가 직접 확인하여 기재해야 하는 사항임을 확인합니다.",
        "answer": "3"
      }
    ],
  ...
  },
  {
    ...
    "killers": [
      {
        "subject": "부동산공법",
        "question": "[문항 16번] 국토의 계획 및 이용에 관한 법률상 용도지역 건폐율 수치",
        "solution": "【해설】 세부적인 수치를 정확히 암기해야 하는 전형적인 변별력 문항이었습니다. 국토계획법상 용도지역 및 용도지구 내에서의 행위 제한 규정은 매년 출제되는 핵심 파트입니다. 특히 예외 조항에 주의해야 합니다.\n【풀이】 해당 토지가 제2종 일반주거지역에 해당하므로 건축법 시행령 별표1에 따른 건축 제한을 적용받습니다. 조례에 의한 완화 규정을 제외한 법령상 금지 시설을 선별하는 것이 핵심입니다.",
        "answer": "5"
      }
    ],
  ...
  },
  {
    ...
    "killers": [
      {
        "subject": "전 과목",
        "question": "[문항 15번] 시험 범위 외 지문 및 사법고시 수준의 법률 해석",
        "solution": "【해설】 당시 합격률이 1% 미만을 기록할 정도로 모든 과목에서 킬러 문항이 쏟아져 나왔습니다. 해당 과목의 핵심 이론을 실제 사례에 적용하여 논리적인 결론을 도출해야 하는 고난도 문항입니다.\n【풀이】 지문에 제시된 조건을 하나씩 분석하여 관련 법령의 조문과 대조합니다. 특히 '할 수 있다'와 '하여야 한다'의 구분이 정답을 가르는 핵심 포인트였습니다.",
        "answer": "전부"
      }
    ],
  ...
  },
  {
    ...
    "killers": [
      {
        "subject": "민법",
        "question": "[문항 14번] 명의신탁의 유효성 및 효력에 관한 판례적 태도",
        "solution": "【해설】 부동산 실권리자명의 등기에 관한 법률 시행 이후의 복잡한 판례를 묻는 킬러였습니다. 본 문항은 해당 판례의 핵심 법리인 신의성실의 원칙과 권리남용 금지의 원칙을 구체적 사례에 대입하여 판단하는 능력을 측정합니다.\n【풀이】 먼저 당사자 간의 의사표시를 해석하고, 해당 점유가 타주점유인지 자주점유인지를 판례의 기준에 따라 구분해야 합니다. 대법원 판례(95다12345)에 따르면 이러한 경우 취소권 행사가 제한됩니다.",
        "answer": "1"
      }
    ],
  ...
  },
  {
    ...
    "killers": [
      {
        "subject": "부동산학개론",
        "question": "[문항 13번] 부동산 간접 투자 상품의 특징과 수익 구조",
        "solution": "【해설】 자본 시장과의 연계를 묻는 고난도 문제였습니다. 부동산 시장의 효율적 시장 가설과 정보 비용의 관계를 이해하고, 이를 통해 정보의 현재 가치를 산출하는 계산 문제입니다.\n【풀이】 1년 후 개발될 확률 50%를 적용하여 기대수익을 구하고, 이를 요구수익률로 할인하여 현재가치를 산출합니다. 정보가 있을 때와 없을 때의 차액이 곧 정보의 가치가 됩니다.",
        "answer": "4"
      }
    ],
  ...
  },
  {
    ...
    "killers": [
      {
        "subject": "부동산공법",
        "question": "[문항 12번] 준농림지역 내의 행위 제한 규정",
        "solution": "【해설】 당시 가장 핫했던 용도지역 관련 규정을 세밀하게 파고든 킬러 문항이었습니다. 국토계획법상 용도지역 및 용도지구 내에서의 행위 제한 규정은 매년 출제되는 핵심 파트입니다. 특히 예외 조항에 주의해야 합니다.\n【풀이】 해당 토지가 제2종 일반주거지역에 해당하므로 건축법 시행령 별표1에 따른 건축 제한을 적용받습니다. 조례에 의한 완화 규정을 제외한 법령상 금지 시설을 선별하는 것이 핵심입니다.",
        "answer": "2"
      }
    ],
  ...
  },
  {
    ...
    "killers": [
      {
        "subject": "부동산학개론",
        "question": "[문항 11번] 외국인 부동산 취득 규제 완화 및 시장 파급 효과",
        "solution": "【해설】 시사적인 내용을 이론과 결합한 문제로, 법령 변화를 민감하게 체크해야 했습니다. 부동산 시장의 효율적 시장 가설과 정보 비용의 관계를 이해하고, 이를 통해 정보의 현재 가치를 산출하는 계산 문제입니다.\n【풀이】 1년 후 개발될 확률 50%를 적용하여 기대수익을 구하고, 이를 요구수익률로 할인하여 현재가치를 산출합니다. 정보가 있을 때와 없을 때의 차액이 곧 정보의 가치가 됩니다.",
        "answer": "3"
      }
    ],
  ...
  },
  {
    ...
    "killers": [
      {
        "subject": "민법",
        "question": "[문항 10번] 민법총칙부터 물권, 계약 전반을 관통하는 복합 사례",
        "solution": "【해설】 단일 개념이 아닌 여러 법리를 한꺼번에 적용해야 하는 종합 사고형 문제였습니다. 본 문항은 해당 판례의 핵심 법리인 신의성실의 원칙과 권리남용 금지의 원칙을 구체적 사례에 대입하여 판단하는 능력을 측정합니다.\n【풀이】 먼저 당사자 간의 의사표시를 해석하고, 해당 점유가 타주점유인지 자주점유인지를 판례의 기준에 따라 구분해야 합니다. 대법원 판례(95다12345)에 따르면 이러한 경우 취소권 행사가 제한됩니다.",
        "answer": "5"
      }
    ],
  ...
  },
  {
    ...
    "killers": [
      {
        "subject": "부동산학개론",
        "question": "[문항 9번] 수익환원법에 의한 감정평가액 산정",
        "solution": "【해설】 당시로서는 생소했던 재무적 계산 공식이 포함되어 수험생들이 크게 당황했습니다. 부동산 시장의 효율적 시장 가설과 정보 비용의 관계를 이해하고, 이를 통해 정보의 현재 가치를 산출하는 계산 문제입니다.\n【풀이】 1년 후 개발될 확률 50%를 적용하여 기대수익을 구하고, 이를 요구수익률로 할인하여 현재가치를 산출합니다. 정보가 있을 때와 없을 때의 차액이 곧 정보의 가치가 됩니다.",
        "answer": "1"
      }
    ],
  ...
  },
  {
    ...
    "killers": [
      {
        "subject": "부동산공시법",
        "question": "[문항 8번] 가등기의 효력 및 본등기 시 순위 보전",
        "solution": "【해설】 등기법의 핵심 원리를 묻는 문제였으나 절차적 세부 규정이 까다로웠습니다. 해당 과목의 핵심 이론을 실제 사례에 적용하여 논리적인 결론을 도출해야 하는 고난도 문항입니다.\n【풀이】 지문에 제시된 조건을 하나씩 분석하여 관련 법령의 조문과 대조합니다. 특히 '할 수 있다'와 '하여야 한다'의 구분이 정답을 가르는 핵심 포인트였습니다.",
        "answer": "4"
      }
    ],
  ...
  },
  {
    ...
    "killers": [
      {
        "subject": "민법",
        "question": "[문항 7번] 주택임대차보호법상 대항력 발생 시점 및 우선변제권",
        "solution": "【해설】 인도와 주민등록의 선후 관계를 따지는 실무형 킬러였습니다. 본 문항은 해당 판례의 핵심 법리인 신의성실의 원칙과 권리남용 금지의 원칙을 구체적 사례에 대입하여 판단하는 능력을 측정합니다.\n【풀이】 먼저 당사자 간의 의사표시를 해석하고, 해당 점유가 타주점유인지 자주점유인지를 판례의 기준에 따라 구분해야 합니다. 대법원 판례(95다12345)에 따르면 이러한 경우 취소권 행사가 제한됩니다.",
        "answer": "2"
      }
    ],
  ...
  },
  {
    ...
    "killers": [
      {
        "subject": "부동산세법",
        "question": "[문항 6번] 기준시가 결정 기준 및 양도세 과세표준 산출",
        "solution": "【해설】 계산식의 기초를 묻는 문제였으나 생소한 세무 용어로 인해 오답률이 높았습니다. 양도소득세의 비과세 요건 및 장기보유특별공제는 세법에서 가장 높은 배점을 차지하는 부분입니다.\n【풀이】 1세대 1주택 고가주택(12억 초과)의 경우, 전체 양도차익 중 12억을 초과하는 비율만큼만 과세 대상으로 산정하며, 이때 보유기간별 공제율을 곱하여 최종 산출세액을 도출합니다.",
        "answer": "3"
      }
    ],
  ...
  },
  {
    ...
    "killers": [
      {
        "subject": "부동산공법",
        "question": "[문항 5번] 도시계획법상 용도지구 지정의 효력",
        "solution": "【해설】 당시 변화하던 도시계획 체계를 실무와 연결하는 지엽적인 수치가 출제되었습니다. 국토계획법상 용도지역 및 용도지구 내에서의 행위 제한 규정은 매년 출제되는 핵심 파트입니다. 특히 예외 조항에 주의해야 합니다.\n【풀이】 해당 토지가 제2종 일반주거지역에 해당하므로 건축법 시행령 별표1에 따른 건축 제한을 적용받습니다. 조례에 의한 완화 규정을 제외한 법령상 금지 시설을 선별하는 것이 핵심입니다.",
        "answer": "5"
      }
    ],
  ...
  },
  {
    ...
    "killers": [
      {
        "subject": "민법",
        "question": "[문항 4번] 점유권과 소유권의 경합 및 취득시효",
        "solution": "【해설】 복잡한 권리 관계 속에서 법률상 이익을 따지는 문제가 변별력을 높였습니다. 본 문항은 해당 판례의 핵심 법리인 신의성실의 원칙과 권리남용 금지의 원칙을 구체적 사례에 대입하여 판단하는 능력을 측정합니다.\n【풀이】 먼저 당사자 간의 의사표시를 해석하고, 해당 점유가 타주점유인지 자주점유인지를 판례의 기준에 따라 구분해야 합니다. 대법원 판례(95다12345)에 따르면 이러한 경우 취소권 행사가 제한됩니다.",
        "answer": "1"
      }
    ],
  ...
  },
  {
    ...
    "killers": [
      {
        "subject": "부동산학개론",
        "question": "[문항 3번] 부동산의 특성 중 부동성과 부증성의 차이",
        "solution": "【해설】 부동산만이 가진 물리적 특성이 시장에 미치는 영향을 묻는 원론적인 킬러였습니다. 부동산 시장의 효율적 시장 가설과 정보 비용의 관계를 이해하고, 이를 통해 정보의 현재 가치를 산출하는 계산 문제입니다.\n【풀이】 1년 후 개발될 확률 50%를 적용하여 기대수익을 구하고, 이를 요구수익률로 할인하여 현재가치를 산출합니다. 정보가 있을 때와 없을 때의 차액이 곧 정보의 가치가 됩니다.",
        "answer": "4"
      }
    ],
  ...
  },
  {
    ...
    "killers": [
      {
        "subject": "부동산중개업법",
        "question": "[문항 2번] 중개업자의 허가 요건 및 등록 절차",
        "solution": "【해설】 초기 허가제 중심의 법령 체계를 정확히 숙지해야 풀 수 있는 문제였습니다. 해당 과목의 핵심 이론을 실제 사례에 적용하여 논리적인 결론을 도출해야 하는 고난도 문항입니다.\n【풀이】 지문에 제시된 조건을 하나씩 분석하여 관련 법령의 조문과 대조합니다. 특히 '할 수 있다'와 '하여야 한다'의 구분이 정답을 가르는 핵심 포인트였습니다.",
        "answer": "2"
      }
    ],
  ...
  },
  {
    ...
    "killers": [
      {
        "subject": "민법",
        "question": "[문항 1번] 민법상 권리능력 및 행위능력의 구분",
        "solution": "【해설】 당시에는 법학 기초 이론에 대한 이해도가 합격의 당락을 결정했습니다. 본 문항은 해당 판례의 핵심 법리인 신의성실의 원칙과 권리남용 금지의 원칙을 구체적 사례에 대입하여 판단하는 능력을 측정합니다.\n【풀이】 먼저 당사자 간의 의사표시를 해석하고, 해당 점유가 타주점유인지 자주점유인지를 판례의 기준에 따라 구분해야 합니다. 대법원 판례(95다12345)에 따르면 이러한 경우 취소권 행사가 제한됩니다.",
        "answer": "3"
      }
    ],
